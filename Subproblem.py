...
if __name__ == "__main__":
    ...
    # m_f = Series([3.0, 5.0, 3.2015621187164243, 3.640054944640259], index=F)
    ...
    # m_g = Series([1.1313708498984762, 3.2984845004941286, 4.308131845707603, 3.2984845004941286, 1.4422205101855958,
    #               4.308131845707603, 2.4000000000000004, 2.529822128134704, 1.6492422502470643, 2.5612496949731396,
    #               2.9120439557122073, 4.0, 2.529822128134704],
    #              index=G)
    ...
    b_vl = DataFrame(b_vl_data, index=V)


    # pi={'AB': 0, 'AD': 0, 'BC': 0, 'DC': 0}
    pi = Series([1] * len(F), index=F)
